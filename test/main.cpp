...
/// Encode/decode params with mask test.
...
int main(void)
{
    ...
    cout << "Encode/Decode params with mask test:" << endl;
...
bool encodeDecodeParamsWithMaskTest()
{
    ...
    mask.width = true;
    mask.height = false;
    mask.displayMode = true;
    mask.videoOutput = false;
    mask.logMode = true;
    mask.exposureMode = false;
    mask.exposureTime = true;
    mask.whiteBalanceMode = false;
    ...
    mask.brightness = false;

    mask.contrast = true;
    mask.gainMode = false;
    mask.gain = true;
    mask.sharpeningMode = false;
    mask.sharpening = true;
    mask.palette = false;
    mask.agcMode = true;
    mask.shutterMode = false;

    mask.shutterPos = true;
    mask.shutterSpeed = false;
    mask.digitalZoomMode = true;
    mask.digitalZoom = false;
    mask.exposureCompensationMode = true;
    mask.exposureCompensationPosition = false;
    mask.defogMode = true;
    mask.dehazeMode = false;

    mask.noiseReductionMode = true;
    mask.blackAndWhiteFilterMode = false;
    mask.filterMode = true;
    mask.nucMode = false;
    mask.autoNucIntervalMsec = true;
    mask.imageFlip = false;
    mask.ddeMode = true;
    mask.ddeLevel = false;
    ...
    mask.alcGate = false;
    mask.sensitivity = true;
    mask.changingMode = false;

    mask.changingLevel = true;
    mask.chromaLevel = false;
    mask.detail = true;
    mask.profile = false;
    ...
    if (0 != out.exposureCompensationPosition)
    {
        cout << "in.exposureCompensationPosition" << endl;
        result = false;
    }
    ...
    if (0 != out.blackAndWhiteFilterMode)
    {
        cout << "in.blackAndWhiteFilterMode" << endl;
        result = false;
    }
    ...
    if (0 != out.chromaLevel)
    {
        cout << "in.chromaLevel" << endl;
        result = false;
    }
    if (in.detail != out.detail)
    {
